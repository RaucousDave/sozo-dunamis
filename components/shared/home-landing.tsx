      ...
      <main className="flex w-full max-w-3xl flex-1 flex-col items-center justify-between bg-white px-16 py-32 dark:bg-black sm:items-start">
        ...
        <div className="flex flex-col items-center gap-6 text-center sm:items-start sm:text-left">
          ...
          <p className="max-w-md text-lg leading-8 text-zinc-600 dark:text-zinc-400">
            ...
            <ResourceLink href="https://vercel.com/templates?framework=next.js&utm_source=create-next-app&utm_medium=appdir-template-tw&utm_campaign=create-next-app">
              Templates
            </ResourceLink>{" "}
            or the{" "}
            <ResourceLink href="https://nextjs.org/learn?utm_source=create-next-app&utm_medium=appdir-template-tw&utm_campaign=create-next-app">
              Learning
            </ResourceLink>{" "}
            center.
          </p>
        ...
        <div className="flex flex-col gap-4 text-base font-medium sm:flex-row">
          ...
          <ActionLink href="https://nextjs.org/docs?utm_source=create-next-app&utm_medium=appdir-template-tw&utm_campaign=create-next-app">
            Documentation
          </ActionLink>
        </div>
      </main>
